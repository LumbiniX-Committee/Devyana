    ...
    return (
        <section className="min-h-screen w-full bg-[#0c0c0c] pt-32 pb-20 px-4 md:px-10">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h1 className="font-serif text-5xl md:text-7xl text-white mb-6">Six Modules, <span className="text-brand-gold">One Path</span></h1>
                    <p className="text-white/60 font-sans text-lg max-w-2xl mx-auto">
                        The practice, compiled for your machine. <br />
                        <span className="text-brand-gold font-bold text-sm uppercase tracking-widest mt-2 inline-block">Double Click to View</span>
                    </p>
                </motion.div>
                        ...
                        >
                            ...
                            <div className="absolute inset-0 p-8 flex flex-col justify-end">
                                ...
                                <div className="h-0 overflow-hidden group-hover:h-auto transition-all duration-500">
                                    ...
                                    <p className="text-brand-gold font-mono text-lg">{dest.price} <span className="text-xs text-white/40 align-middle">/ Forever</span></p>
                                </div>
                            </div>
                            ...
                            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                <div className="bg-black/60 backdrop-blur-md px-6 py-2 rounded-full border border-white/20">
                                    <span className="text-white text-xs uppercase tracking-widest font-bold">Double Click to View</span>
                                </div>
                            </div>
                        </motion.div>
                    ))}
