...
export const NameStep = ({ initialName, onSubmit }: NameStepProps) => {
	...
	return (
		<div className="flex min-h-screen w-full flex-col items-center justify-center px-6">
			...
			>
				...
				>
					<input
						// biome-ignore lint/a11y/noAutofocus: the name field is the only interactive control on this screen
						autoFocus
						value={value}
