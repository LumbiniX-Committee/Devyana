...
function Block() {
	...
	const [isChallengeAccepted, setIsChallengeAccepted] =
					...
					{isChallengeAccepted ? (
						<div className="w-148 h-148 border bg-yellow-400">
							<video
								...
								playsInline
								className={cn(
									"w-full h-full object-cover border bg-blue-400",
						...
						<button
							onClick={() => setIsChallengeAccepted(true)}
							type="button"
							className="p-4 cursor-pointer rounded-xl bg-green-200"
						>
