...
import { ArrowUp, Sparkles, RotateCcw, Target } from "lucide-react";
...
export default function Dashboard() {
  ...
  const name = (typeof window !== "undefined" && localStorage.getItem("vinaya_name")) || "friend";
  const role = (typeof window !== "undefined" && localStorage.getItem("vinaya_role")) || null;
  const goal = (typeof window !== "undefined" && localStorage.getItem("vinaya_goal")) || null;
          ...
          >
            ...
            <div className="glass-card mt-8 rounded-3xl p-3 text-left">
              ...
              <div className="flex items-center justify-between px-1 pb-1">
                <span className="text-xs text-foreground/45">Prototype · mindful companion</span>
                <button
                  onClick={reflect}
